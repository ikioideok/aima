...
export const articles: Article[] = [
    {
        id: 'llmo-marketing',
        title: 'LLMO（Large Language Model Optimization）とは？生成AI時代の新しいSEO対策',
        subtitle: '検索エンジンから「対話型AI」へ。マーケティングの主戦場が変わる中で、企業が取り組むべき新たな最適化戦略について解説します。',
        date: '2024.03.15',
        category: 'MARKETING',
        image: 'https://images.unsplash.com/photo-1677442136019-21780ecad995?q=80&w=2832&auto=format&fit=crop',
        excerpt: '生成AIが日常的なツールとして定着する中、自社の情報がAIの回答に正確に反映されているか不安を感じる企業が増えています。検索エンジンの上位表示を目指すだけでは不十分な時代において、AIからの参照を獲得する新たな手法が求められています。',
        displayType: 'SPECIAL',
        supervisor: {
            name: '水間 雄紀',
            role: 'CEO',
            image: 'https://media.licdn.com/dms/image/v2/D5603AQFwXqXqXqXqXq/profile-displayphoto-shrink_800_800/0/1700000000000?e=2147483647&v=beta&t=xxxx', // Note: Placeholder, user might need to update this URL if it was local
            comment: 'LLMの普及は、情報の「探され方」を根本から変えようとしています。これからのマーケターは、人間にどう届けるかだけでなく、AIにどう学習されるかを設計する必要があります。'
        },
        content: `
            <section>
                <h2 className="text-2xl font-bold mb-4">LLMOの定義と意味</h2>
                <p className="mb-6">
