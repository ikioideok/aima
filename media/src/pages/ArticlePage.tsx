            ...
            wrapper.innerHTML = `
              <div class="my-8 p-4 border rounded-lg bg-card/50" data-cta="inline">
                ...
                <div class="flex flex-col md:flex-row md:items-center gap-3">
                  ...
                  >
                    <span style="position:relative;z-index:1;color:#fff;-webkit-text-fill-color:#fff;text-shadow:0 1px 0 rgba(0,0,0,.3),0 0 2px rgba(0,0,0,.2);-webkit-text-stroke:0.25px rgba(0,0,0,.15)">${cfg.buttonText}</span>
                  </a>
                </div>
              </div>`;
